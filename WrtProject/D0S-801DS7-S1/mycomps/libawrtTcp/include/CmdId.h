...
#define ROOM_MONT_IDLE		    (CMD_ID(0x0102))
...
//801X指令
#define _901X_CALL       		(CMD_ID(0x9001))
#define _901X_IDLE       		(CMD_ID(0x9002))
#define _901X_BUSY       		(CMD_ID(0x9003))
#define _901X_HOLD       		(CMD_ID(0x9004))
#define _901X_OPEN       		(CMD_ID(0x9005))
#define _901X_END        		(CMD_ID(0x9006))
#define _901X_MEDIA      		(CMD_ID(0x9007))
#define _901X_MSG        		(CMD_ID(0x9008))
#define _901X_CALL_PROCESSING   (CMD_ID(0x9009))
#define _901X_LIFT_CTRL   		(CMD_ID(0x900e))
#define _901X_GETCON   			(CMD_ID(0x9011))
#define _901X_GETCON_ACK   		(CMD_ID(0x9012))
//2008-11-14
...
#define DEV_SEND_DEBUGLOG                 (CMD_ID(0x1183))  //  0x1183
/***2009-11-27 end ***/
//报警id
