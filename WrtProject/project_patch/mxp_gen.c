...
mtd3: 00400000 00010000 "nvrservice"
mtd4: 004f0000 00010000 "customer"
*/
    i=0;
    ...
    out_record("rootfs",    (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x00250000, 0x00500000, MXP_PART_STATUS_EMPTY, i++);
    out_record("nvrservice",      (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x00750000, 0x00200000, MXP_PART_STATUS_EMPTY, i++);
    out_record("customer",      (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x00950000, 0x006B0000, MXP_PART_STATUS_EMPTY, i++);
